...
- 实验指纹：`9c4c67888e46bc154e813411762e66ce737fc3dfd262788b7ce31d636e38e7fc`
- 问题数：4
- Ragas 实际评分率：50.00%
- 回答状态正确率：50.00%
- 发布门禁：未启用，仅作诊断
...
| 指标 | 平均分 | 诊断阈值 |
|---|---:|---:|
| selected_context_precision | 0.7375（待改进） | 0.8 |
| selected_context_recall | 0.5000（待改进） | 0.8 |
| response_faithfulness | 1.0000（达标） | 0.9 |
| answer_relevancy | 0.8410（达标） | 0.8 |
| citation_faithfulness | 0.5000（待改进） | 0.9 |
| citation_validity | 1.0000 | N/A |
| paper_id_precision | 0.6667 | N/A |
